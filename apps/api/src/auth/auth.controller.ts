...
export async function signupController (request:FastifyRequest<{
    Body: SignupDto
}>,reply:FastifyReply) {
...
export async function loginController (request:FastifyRequest<{Body:LoginDto}>,reply:FastifyReply) {
